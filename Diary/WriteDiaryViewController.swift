...
class WriteDiaryViewController: UIViewController {
    ...
    //날짜버튼을 선택했을 때 키패드가 아닌 데이트피커가 뜨도록 설정 20211227@LDH start
    //configureDatePicker의 selector 값 설정
    @objc private func datePickerValueDidChange(_ datePicker: UIDatePicker) {
        ...
        //dateTextField는 텍스트를 키보드로 입력받는 형태가 아니기에 dataTextFieldDidChage 메서드가 실행되지 않음 -> 데이트피커의 날짜가 변경될 때마다 EditingChange 액션을 발생시켜 dateTextFieldDidChange 메서드가 호출되게 구현
